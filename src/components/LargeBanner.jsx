                    ...
                    <div className="row mb-n4">
                        <div className="col-lg-4 mb-4">
                            <div className="large-banner-content text-center text-lg-end">
                                ...
                                <Link to="/shop" className="btn  bg-dark text-light">Shop Decor</Link>
                                <Link to="/shop" className="btn  bg-dark text-light">Shop Furniture</Link>
                            </div>
                        ...
                        <div className="col-lg-8 mb-4">
                            <div className="large-banner-wrap position-relative">
                                <Link to="/shop" className="large-thumb-nail">
                                    <img src="../assets/images/banner/banner4.jpg" alt="image_not_found"/>
                                </Link>
                                {/*/!*<!-- thumb-nail end-->*!/*/}
                                <Link to="/shop" className="small-thumb-nail">
