                            ...
                            <div className="product-desc ">
                                <div className="product-desc-top">
                                    <div className="categories">
                                        <a href="shop3.html" className="product-category"><span>Woman</span></a>
                                    </div>
                    ...
                    <div className="product-box ">
                        <div className="product-box-wrapper">
                            ...
                            <div className="product-desc ">
                                <div className="product-desc-top">
                                    <div className="categories">
                                        <a href="shop3.html" className="product-category"><span>Shoes</span></a>
                                        <a href="shop3.html" className="product-category"><span>Sneaker</span></a>
                                        <a href="shop3.html" className="product-category"><span>Women</span></a>
                                    </div>
                                    <a href="wishlist.html" className="wishlist float-right"><span><i className="fal fa-heart" /></span></a>
                                </div>
